...
for _ in range(int(os.getenv('COUNT'))):
    ...
    def add_subtitles():
        ...
        style_x, style_y = map(int, os.getenv('CORD_STYLE').split())
        size_x, size_y = map(int, os.getenv('CORD_SIZE').split())
        ...
        pyautogui.moveTo(style_x, style_y)
        time.sleep(10)
        pyautogui.click()
        pyautogui.click(size_x, size_y)
