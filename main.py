        ...
        def add_text_in_content1(time_end, text):
            ...
            with open(
                ...
                pupu = {'add_type': 0, 'alignment': 1, 'background_alpha': 1.0,
                        ...
                        'content': '{"text":"pipi","styles":[{"fill":{"content":{"solid":{"color":[1,1,1]}}},"font":{"path":"C:/Users/AsRock/Downloads/FRAHV.TTF","id":""},"strokes": [{"content":{"solid":{"color":[0,0,0]}},"width":0.08}],"size":30,"range":[0,100]}]}',
                        'fixed_height': -1.0, 'fixed_width': -1.0,
                        'font_category_id': '', 'font_category_name': '',
                        'font_id': '', 'font_name': '',
                        'font_path': 'C:/Users/AsRock/Downloads/FRAHV.TTF',
